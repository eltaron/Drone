...
(5, '2022_12_09_185446_create_products_table', 1),
(6, '2022_12_09_185459_create_articles_table', 1),
(7, '2022_12_09_185512_create_points_table', 1),
(8, '2022_12_09_185525_create_rates_table', 1),
(9, '2022_12_09_185536_create_shops_table', 1),
(10, '2022_12_09_185553_create_notifications_table', 1),
(11, '2022_12_09_185605_create_carts_table', 1),
(12, '2022_12_09_185625_create_wishlists_table', 1),
(13, '2022_12_09_185844_create_cities_table', 1),
(14, '2022_12_09_185855_create_countries_table', 1),
...
(19, '2022_12_09_191116_create_orders_table', 1),
(20, '2022_12_09_191220_create_addresses_table', 1),
(21, '2022_12_09_191231_create_discount_coupons_table', 1),
...
(27, '2022_12_10_113609_create_categories_table', 2),
(28, '2022_12_10_114338_create_chats_table', 2),
(29, '2022_12_10_114350_create_chat_messages_table', 2),
(30, '2022_12_10_114416_create_messages_table', 2);
...
CREATE TABLE `users` (
  ...
  `city_id` bigint(20) UNSIGNED NOT NULL,
  `by_store` tinyint(4) NOT NULL DEFAULT 0,
...
--
ALTER TABLE `chat_messages`
  ADD CONSTRAINT `chat_messages_ibfk_1` FOREIGN KEY (`chat_id`) REFERENCES `chats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `comments_ibfk_3` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `discount_coupons`
--
ALTER TABLE `discount_coupons`
  ADD CONSTRAINT `discount_coupons_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `images`
  ...
  ADD CONSTRAINT `images_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `images_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `likes`
  ...
  ADD CONSTRAINT `likes_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`discount_coupon_id`) REFERENCES `discount_coupons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`shop_id`) REFERENCES `shops` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `recieve_money`
  ADD CONSTRAINT `recieve_money_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `returneds`
--
ALTER TABLE `returneds`
  ADD CONSTRAINT `returneds_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `returneds_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
